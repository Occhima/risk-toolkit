...
def curve(*identity: str, indexer_col: str = "id_indexador", tenor_col: str = "payment_days",
          outputs: dict[str, str] | None = None) -> MarketRequirement:
...
def fixing(*, indexer_col: str = "id_indexador", date_col: str = "base_date",
           output: str = "base_index") -> MarketRequirement:
    return MarketRequirement("fixings", (indexer_col, date_col), (indexer_col, "fixing_date"),
                             {"fixing_value": output})


def projected_index(*, indexer_col: str = "id_indexador", tenor_col: str = "payment_days",
                    output: str = "projected_index") -> MarketRequirement:
    return MarketRequirement("projected_indexes", (indexer_col, tenor_col), (indexer_col, "tenor_days"),
                             {"projected_index": output})


def energy_forward(*, submarket_col: str = "submarket", period_col: str = "delivery_period",
                   outputs: dict[str, str] | None = None) -> MarketRequirement:
    ...
    return MarketRequirement("forward_curves", (submarket_col, period_col),
                             ("submarket", "delivery_period"), out)
...
class MarketSnapshot:
    ...
    forward_curves: pl.LazyFrame | None = None     # submarket, delivery_period, forward_price, settle_days
    ...
    def attach(self, lf: pl.LazyFrame, req: MarketRequirement) -> pl.LazyFrame:
        ...
        return lf.join(right, left_on=list(req.left_keys), right_on=list(req.right_keys), how="left")
